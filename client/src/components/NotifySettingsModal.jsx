  ...
  return (
    <div className="modal-backdrop" onClick={onClose}>
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-label={t("notify.dialogAria")}
      >
        {/* Header */}
        <div className="modal-header">
          <div>
            <h2 className="modal-title">{t("notify.title")}</h2>
            <p className="modal-subtitle">{t("notify.subtitleModal")}</p>
          </div>
          <button className="modal-close" onClick={onClose} aria-label={t("notify.close")}>
            ✕
          </button>
        </div>
        ...
        <div className="modal-footer">
          ...
          <button
            ...
            disabled={saving}
          >
            {saving ? t("notify.saving") : t("notify.save")}
          </button>
        </div>
      </div>
    </div>
